...
The Taylor basis functions (see \cite{vertex}) and Divergence-free basis functions (\Cref{tbl:divFreeBasis}) of order $0$ (piecewise constant functions) and $1$ (piecewise linear functions) were used.
...
Results obtained in the implemented software are presented in \Cref{figure:myOt1 - figure:myOt3}
