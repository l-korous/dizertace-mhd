...
\end{algorithm}
Note that in this algorithm, periodic boundary conditions are not specifically handled, as they are only a programatically more complex case of internal edges.