...
\end{tabular*}
	\begin{tabular*}{\textwidth}{cccc}
	$\lo\begin{array}{c}1\\0\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/1.jpg}} & $\lo\begin{array}{c}0\\0\\y \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/6.jpg}}\\
	\\	
	$\lo\begin{array}{c}0\\1\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/2.jpg}} & $\lo\begin{array}{c}z\\0\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/7.jpg}}\\
		\\	
	$\lo\begin{array}{c}0\\0\\1 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/3.jpg}} & $\lo\begin{array}{c}0\\z\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/8.jpg}}\\
		\\	
	$\lo\begin{array}{c}y\\0\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/4.jpg}} & $\lo\begin{array}{c}0\\0\\x \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/9.jpg}}\\
		\\	
	$\lo\begin{array}{c}0\\x\\0 \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/5.jpg}} & $\lo\begin{array}{c}2x\\-y\\-z \end{array}\ro$ & \raisebox{-0.5\totalheight}{\includegraphics[width=0.3\textwidth]{img/basis/10.jpg}}\\	
	\\	
			\hline		
		\end{tabular*}
