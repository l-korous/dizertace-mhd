...
The simple time discretization scheme that we use in \Cref{section:discreteProblem} on the page \pageref{section:discreteProblem} allows us to simply implement the time-stepping in the following fashion:\\
\begin{algorithm}[H]
