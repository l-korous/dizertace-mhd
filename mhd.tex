...
\section{Equations}
   ...
   \end{align}
		...
		\begin{eqnarray}
			...
			+ \frac{1}{Re} \int_{\Omega} \nabla v_x \cdot \nabla \varphi
			\nonumber & -\\- \int_{\Omega} \left({\mathbf{J}_{ext}}_y C_z - {\mathbf{J}_{ext}}_z C_y\right) \varphi			
			- \int_{\Omega} \sigma \left({\mathbf{J}_{ext}}_z C_x C_z - {\mathbf{J}_{ext}}_x C_z C_z - {\mathbf{J}_{ext}}_x C_y C_y + {\mathbf{J}_{ext}}_y C_x C_y\right)\, \varphi
			& = & 0\nonumber \\
			...
			+ \frac{1}{Re} \int_{\Omega} \nabla v_y \cdot \nabla \varphi
			\nonumber & -\\- \int_{\Omega} \left({\mathbf{J}_{ext}}_z C_x - {\mathbf{J}_{ext}}_x C_z\right) \varphi			
			- \int_{\Omega} \sigma \left({\mathbf{J}_{ext}}_x C_y C_x - {\mathbf{J}_{ext}}_y C_x C_x - {\mathbf{J}_{ext}}_y C_z C_z + {\mathbf{J}_{ext}}_z C_y C_z\right)\, \varphi
			& = & 0\nonumber \\
			...
			+ \frac{1}{Re} \int_{\Omega} \nabla v_z \cdot \nabla \varphi
			\nonumber & -\\- \int_{\Omega} \left({\mathbf{J}_{ext}}_x C_y - {\mathbf{J}_{ext}}_y C_x\right) \varphi			
			- \int_{\Omega} \sigma \left({\mathbf{J}_{ext}}_y C_z C_y - {\mathbf{J}_{ext}}_z C_y C_y - {\mathbf{J}_{ext}}_z C_x C_x + {\mathbf{J}_{ext}}_x C_z C_x\right)\, \varphi
			& = & 0\nonumber \\			
