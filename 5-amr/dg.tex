...
\paragraph{}
The setup here is the same one used in \Cref{section:ditributedTria}, but periodic boundary conditions were added to the left-right and top-bottom boundary part pairs.
